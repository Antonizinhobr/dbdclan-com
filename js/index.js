...
const mapList = [
  {
    ...
    variants: [
      {
        name: "SEPULTURA DE AZAROV",
        img: "../assets/img/Ferro-Velho Autohaven/Sepultura de Azarov.png",
      },
      {
        name: "ABRIGO SANGRENTO",
        img: "../assets/img/Ferro-Velho Autohaven/Abrigo Sangrento.png",
      },
      {
        name: "PARAÍSO DO COMBUSTÍVEL",
        img: "../assets/img/Ferro-Velho Autohaven/Paraíso do Combustível.png",
      },
      {
        name: "LOJA DESGRAÇADA",
        img: "../assets/img/Ferro-Velho Autohaven/Loja Desgraçada.png",
      },
      {
        name: "QUINTAL DO FERRO VELHO",
        img: "../assets/img/Ferro-Velho Autohaven/Quintal do Ferro Velho.png",
      },
    ],
  },
  {
    ...
    variants: [
      {
        name: "SALA DE TRATAMENTO",
        img: "../assets/img/Instituto Memorial Léry/Instituto Memorial Léry.png",
      },
    ],
  },
  {
    ...
    variants: [
      {
        name: "REFÚGIO DA CAÇADORA",
        img: "../assets/img/Floresta Vermelha/Refúgio da Caçadora.png",
      },
      {
        name: "O TEMPLO DA PURGAÇÃO",
        img: "../assets/img/Floresta Vermelha/O Templo da Purgação.png",
      },
    ],
  },
  {
    ...
    variants: [
      {
        name: "TORRE DO CARVÃO 1",
        img: "../assets/img/Propriedade Macmillan/Torre de Carvão 1.png",
      },
      {
        name: "TORRE DO CARVÃO 2",
        img: "../assets/img/Propriedade Macmillan/Torre de Carvão 2.png",
      },
      {
        name: "ARMAZÉM RANGENTE 1",
        img: "../assets/img/Propriedade Macmillan/Armazem Rangente 1.png",
      },
      {
        name: "ARMAZÉM RANGENTE 2",
        img: "../assets/img/Propriedade Macmillan/Armazem Rangente 2.png",
      },
      {
        name: "FÁBRICA DA MISÉRIA 1",
        img: "../assets/img/Propriedade Macmillan/Fábrica da Miséria 1.png",
      },
      {
        name: "FÁBRICA DA MISÉRIA 2",
        img: "../assets/img/Propriedade Macmillan/Fábrica da Miséria 2.png",
      },
      {
        name: "BOSQUE DO ABRIGO 1",
        img: "../assets/img/Propriedade Macmillan/Bosque do abrigo 1.png",
      },
      {
        name: "BOSQUE DO ABRIGO 2",
        img: "../assets/img/Propriedade Macmillan/Bosque do abrigo 2.png",
      },
      {
        name: "FOSSO DO SUFOCAMENTO 1",
        img: "../assets/img/Propriedade Macmillan/Fosso do sufocamento 1.png",
      },
      {
        name: "FOSSO DO SUFOCAMENTO 2",
        img: "../assets/img/Propriedade Macmillan/Fosso do sufocamento 2.png",
      },
    ],
  },
  {
    ...
    variants: [
      {
        name: "O JOGO",
        img: "../assets/img/Fábrica de Embalagem de Carnes Gideon/O Jogo.png",
      },
    ],
  },
  {
    ...
    variants: [
      {
        name: "ESTÁBULO FRATURADO",
        img: "../assets/img/Fazenda Cooldwind/Estábulo Fraturado.png",
      },
      {
        name: "A CASA DOS THOMPSON",
        img: "../assets/img/Fazenda Cooldwind/A Casa Dos Thompson.png",
      },
      {
        name: "CÓRREGO ATORMENTADOR",
        img: "../assets/img/Fazenda Cooldwind/Córrego Atormentador.png",
      },
      {
        name: "ABATEDOURO ASQUEROSO",
        img: "../assets/img/Fazenda Cooldwind/Abatedouro Asqueroso.png",
      },
      {
        name: "CAMPOS PÚTRIDOS",
        img: "../assets/img/Fazenda Cooldwind/Campos Pútridos.png",
      },
    ],
  },
  {
    ...
    variants: [
      {
        name: "ESCOLA PRIMÁRIA MIDWICH",
        img: "../assets/img/Silent Hill/Escola Primária Midwich.png",
      },
    ],
  },
  {
    ...
    variants: [
      {
        name: "SALOON DEAD DAWGS",
        img: "../assets/img/Túmulo de Glenvale/Saloon Do Cachorro Morto.png",
      },
    ],
  },
];
...
onSnapshot(doc(db, "sistema", "status"), (snapshot) => {
  ...
  onAuthStateChanged(auth, (user) => {
    ...
    if (data.votacaoIniciada) {
      ...
      if (statusText)
        statusText.innerText = "VOTAÇÃO EM ANDAMENTO: Escolha um Reino!";
      ...
      if (isAdmin) {
        ...
        if (statusText)
          statusText.innerText =
            "PAINEL ADMIN: Inicie a votação quando pronto.";
      } else {
        if (statusText)
          statusText.innerText = "Analise os Reinos. Aguarde o Admin.";
      }

      if (!data.vencedorNome) {
        renderizarMapas(
          mapList.map((m) => m.name),
          false,
        );
      }
    }
...
document.getElementById("start-btn")?.addEventListener("click", async () => {
  ...
  mapList.forEach((m) =>
    batch.set(doc(db, "VOTOS", m.name), { quantidade: 0 }, { merge: true }),
  );

  batch.set(
    doc(db, "sistema", "status"),
    {
...
document.getElementById("finish-btn")?.addEventListener("click", async () => {
  ...
  if (!statusData || !statusData.votacaoIniciada)
    return alert("Inicie a votação!");
...
document.getElementById("reset-btn")?.addEventListener("click", async () => {
  ...
  batch.set(
    doc(db, "sistema", "status_variante"),
    { votacaoAberta: true },
    { merge: true },
  );
  mapList.forEach((m) =>
